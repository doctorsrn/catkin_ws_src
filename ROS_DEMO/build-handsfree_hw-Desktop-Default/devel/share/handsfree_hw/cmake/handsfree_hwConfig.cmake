...
if("TRUE" STREQUAL "TRUE")
  set(handsfree_hw_SOURCE_PREFIX /home/vency/ros_workspace/src/ROS_DEMO/handsfree_hw)
  set(handsfree_hw_DEVEL_PREFIX /home/vency/ros_workspace/src/ROS_DEMO/build-handsfree_hw-Desktop-Default/devel)
...
if(NOT "/home/vency/ros_workspace/src/ROS_DEMO/handsfree_hw/include " STREQUAL " ")
  set(handsfree_hw_INCLUDE_DIRS "")
  set(_include_dirs "/home/vency/ros_workspace/src/ROS_DEMO/handsfree_hw/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'handsfree_hw' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'luke_liao <luke_liao@126.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'handsfree_hw' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vency/ros_workspace/src/ROS_DEMO/handsfree_hw/${idir}'.  Ask the maintainer 'luke_liao <luke_liao@126.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vency/ros_workspace/src/ROS_DEMO/build-handsfree_hw-Desktop-Default/devel/lib;/home/vency/catkin_ws/devel/lib;/home/vency/ros_workspace/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${handsfree_hw_dep}_FOUND)
      find_package(${handsfree_hw_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${handsfree_hw_dep} REQUIRED ${depend_list})
  endif()
